...
char* ToolsOff::TOOLS_OFF_MESSAGE_OFF = const_cast<char*>(LOCAL_TOOLS_OFF_MESSAGE_OFF_TEXT);
char* ToolsOff::TOOLS_OFF_MESSAGE_REBOOT = const_cast<char*>(LOCAL_TOOLS_OFF_MESSAGE_REBOOT_TEXT);
