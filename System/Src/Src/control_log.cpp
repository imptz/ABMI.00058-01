...
char* LogControl::UP_BUTTON_NAME = const_cast<char*>(LOCAL_LOG_CONTROL_UP_BUTTON_NAME);
char* LogControl::DOWN_BUTTON_NAME = const_cast<char*>(LOCAL_LOG_CONTROL_DOWN_BUTTON_NAME);
char* LogControl::LAST_BUTTON_NAME = const_cast<char*>(LOCAL_LOG_CONTROL_LAST_BUTTON_NAME);
