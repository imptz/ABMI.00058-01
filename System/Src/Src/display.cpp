...
void Display::modifyCharTable1(){
	Cpu::outPort(REGISTERS_VGA_SEQUENCER_INDEX, static_cast<unsigned char>(0));
	Cpu::outPort(REGISTERS_VGA_SEQUENCER_DATA, static_cast<unsigned char>(1));
	Cpu::outPort(REGISTERS_VGA_SEQUENCER_INDEX, static_cast<unsigned char>(0));
	Cpu::outPort(REGISTERS_VGA_SEQUENCER_DATA, static_cast<unsigned char>(3));
	
	Cpu::outPort(REGISTERS_VGA_SEQUENCER_INDEX, static_cast<unsigned char>(2));
	unsigned char seq2 = Cpu::inPort(REGISTERS_VGA_SEQUENCER_DATA);

	Cpu::outPort(REGISTERS_VGA_SEQUENCER_INDEX, static_cast<unsigned char>(4));
	unsigned char seq4 = Cpu::inPort(REGISTERS_VGA_SEQUENCER_DATA);

	Cpu::outPort(REGISTERS_VGA_SEQUENCER_DATA, static_cast<unsigned char>(seq4 | 0x04));

	Cpu::outPort(REGISTERS_VGA_GRAPHICS_CONTROLLER_INDEX, static_cast<unsigned char>(4));
	unsigned char gc4 = Cpu::inPort(REGISTERS_VGA_GRAPHICS_CONTROLLER_DATA);

	Cpu::outPort(REGISTERS_VGA_GRAPHICS_CONTROLLER_INDEX, static_cast<unsigned char>(5));
	unsigned char gc5 = Cpu::inPort(REGISTERS_VGA_GRAPHICS_CONTROLLER_DATA);

	Cpu::outPort(REGISTERS_VGA_GRAPHICS_CONTROLLER_DATA, static_cast<unsigned char>(gc5 & ~0x10));

	Cpu::outPort(REGISTERS_VGA_GRAPHICS_CONTROLLER_INDEX, static_cast<unsigned char>(6));
	unsigned char gc6 = Cpu::inPort(REGISTERS_VGA_GRAPHICS_CONTROLLER_DATA);

	Cpu::outPort(REGISTERS_VGA_GRAPHICS_CONTROLLER_DATA, static_cast<unsigned char>(gc6 & ~0x02));
	...
	Cpu::outPort(REGISTERS_VGA_GRAPHICS_CONTROLLER_INDEX, static_cast<unsigned char>(4));
	Cpu::outPort(REGISTERS_VGA_GRAPHICS_CONTROLLER_DATA, static_cast<unsigned char>(p));

	Cpu::outPort(REGISTERS_VGA_SEQUENCER_INDEX, static_cast<unsigned char>(2));
	Cpu::outPort(REGISTERS_VGA_SEQUENCER_DATA, static_cast<unsigned char>(pmask));
	...
	Cpu::outPort(REGISTERS_VGA_SEQUENCER_DATA, static_cast<unsigned char>(3));
	Cpu::outPort(REGISTERS_VGA_SEQUENCER_INDEX, static_cast<unsigned char>(2));
	Cpu::outPort(REGISTERS_VGA_SEQUENCER_DATA, static_cast<unsigned char>(seq2));
	Cpu::outPort(REGISTERS_VGA_SEQUENCER_INDEX, static_cast<unsigned char>(4));
	Cpu::outPort(REGISTERS_VGA_SEQUENCER_DATA, static_cast<unsigned char>(seq4));
	Cpu::outPort(REGISTERS_VGA_GRAPHICS_CONTROLLER_INDEX, static_cast<unsigned char>(4));
	Cpu::outPort(REGISTERS_VGA_GRAPHICS_CONTROLLER_DATA, static_cast<unsigned char>(gc4));
	Cpu::outPort(REGISTERS_VGA_GRAPHICS_CONTROLLER_INDEX, static_cast<unsigned char>(5));
	Cpu::outPort(REGISTERS_VGA_GRAPHICS_CONTROLLER_DATA, static_cast<unsigned char>(gc5));
	Cpu::outPort(REGISTERS_VGA_GRAPHICS_CONTROLLER_INDEX, static_cast<unsigned char>(6));
	Cpu::outPort(REGISTERS_VGA_GRAPHICS_CONTROLLER_DATA, static_cast<unsigned char>(gc6));
}
...
void Display::modifyCharTable(){
	...
	Cpu::outPort(REGISTERS_VGA_SEQUENCER_DATA, static_cast<unsigned char>(3));
	Cpu::outPort(REGISTERS_VGA_SEQUENCER_INDEX, static_cast<unsigned char>(4));
	Cpu::outPort(REGISTERS_VGA_SEQUENCER_DATA, static_cast<unsigned char>(7));
	Cpu::outPort(REGISTERS_VGA_SEQUENCER_INDEX, static_cast<unsigned char>(2));
	Cpu::outPort(REGISTERS_VGA_SEQUENCER_DATA, static_cast<unsigned char>(4));
	Cpu::outPort(REGISTERS_VGA_GRAPHICS_CONTROLLER_INDEX, static_cast<unsigned char>(4));
	Cpu::outPort(REGISTERS_VGA_GRAPHICS_CONTROLLER_DATA, static_cast<unsigned char>(2));
	Cpu::outPort(REGISTERS_VGA_GRAPHICS_CONTROLLER_INDEX, static_cast<unsigned char>(5));
	Cpu::outPort(REGISTERS_VGA_GRAPHICS_CONTROLLER_DATA, static_cast<unsigned char>(0));
	Cpu::outPort(REGISTERS_VGA_GRAPHICS_CONTROLLER_INDEX, static_cast<unsigned char>(6));
	Cpu::outPort(REGISTERS_VGA_GRAPHICS_CONTROLLER_DATA, static_cast<unsigned char>(4));
	...
	Cpu::outPort(REGISTERS_VGA_GRAPHICS_CONTROLLER_DATA, static_cast<unsigned char>(0));
	Cpu::outPort(REGISTERS_VGA_GRAPHICS_CONTROLLER_INDEX, static_cast<unsigned char>(5));
	Cpu::outPort(REGISTERS_VGA_GRAPHICS_CONTROLLER_DATA, static_cast<unsigned char>(0x10));
	Cpu::outPort(REGISTERS_VGA_GRAPHICS_CONTROLLER_INDEX, static_cast<unsigned char>(6));
	Cpu::outPort(REGISTERS_VGA_GRAPHICS_CONTROLLER_DATA, static_cast<unsigned char>(0x0e));
}

void Display::disableCursor(){
	Cpu::outPort(REGISTERS_VGA_CRTC_INDEX, static_cast<unsigned char>(0x0a));
	Cpu::outPort(REGISTERS_VGA_CRTC_DATA, static_cast<unsigned char>(0x20));
}
