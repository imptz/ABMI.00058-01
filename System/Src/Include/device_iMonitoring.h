#ifndef DEVICE_IMONITORING_H
#define DEVICE_IMONITORING_H
...
public:
    enum MESSAGE_NUMBER{
        ...
        MESSAGE_NUMBER_NIZKOE_NAPRAZHENIE_PITANIA_DRAIVERA_V_NORME = 14,
        MESSAGE_NUMBER_VISOKOE_NAPRAZHENIE_PITANIA_DRAIVERA = 15,
        MESSAGE_NUMBER_VISOKOE_NAPRAZHENIE_PITANIA_DRAIVERA_V_NORME = 16,
        MESSAGE_NUMBER_NIZKOE_NAPRAZHENIE_PITANIA_PLATI = 17,
        MESSAGE_NUMBER_NIZKOE_NAPRAZHENIE_PITANIA_PLATI_V_NORME = 18,
        MESSAGE_NUMBER_VISOKOE_NAPRAZHENIE_PITANIA_PLATI = 19,
        MESSAGE_NUMBER_VISOKOE_NAPRAZHENIE_PITANIA_PLATI_V_NORME = 20,
        ...
        MESSAGE_NUMBER_NAPRAZHENIE_PITANIA_NIZHE_NORMI = 35,
        MESSAGE_NUMBER_NAPRAZHENIE_PITANIA_NIZHE_NORMI_V_NORME = 36,
        MESSAGE_NUMBER_NAPRAZHENIE_PITANIA_VISHE_NORMI = 37,
        MESSAGE_NUMBER_NAPRAZHENIE_PITANIA_VISHE_NORMI_V_NORME = 38,
        MESSAGE_NUMBER_PR_NIZROE_NAPRAZHENIE_PITENIA_PROCESSORA = 41,
        MESSAGE_NUMBER_PR_NIZROE_NAPRAZHENIE_PITENIA_PROCESSORA_V_NORME = 42,
        MESSAGE_NUMBER_OBRIV_DATCHIKA_DAVLENIA = 43,
        MESSAGE_NUMBER_OBRIV_DATCHIKA_DAVLENIA_V_NORME = 44,
        MESSAGE_NUMBER_KZ_DATCHIKA_DAVLENIA = 45,
        MESSAGE_NUMBER_KZ_DATCHIKA_DAVLENIA_V_NORME = 46,
        ...
        MESSAGE_NUMBER_OBRIV_DATCHIKA_TEMPERATURI_ISPRAVEN = 67,
        MESSAGE_NUMBER_KZ_DATCHIKA_TEMPERATURI = 68,
        MESSAGE_NUMBER_KZ_DATCHIKA_TEMPERATURI_ISPRAVEN = 69,
        ...
        MESSAGE_NUMBER_TEMPERATURA_SHU_VISHE_NORMI_V_NORME = 97,
        MESSAGE_NUMBER_TEMPERATURA_SHU_NIZHE_NORMI = 98,
        MESSAGE_NUMBER_TEMPERATURA_SHU_NIZHE_NORMI_V_NORME = 99,
        ...
        MESSAGE_NUMBER_ZATVOR_V_NORME = 127,
