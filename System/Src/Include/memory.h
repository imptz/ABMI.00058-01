...
* @return ��������� �� ������� ������.
*/
extern "C" void* memset(void *pTarget, int value, size_t size);
...
* @return ��������� �� ������� ������ ��������.
*/
extern "C" void* memcpy(void *pTarget, void *pSource, size_t size);
...
public:
    ...
    */
    unsigned char* allocate(){
        ...
        new(next) MemoryList<elementSize>;
