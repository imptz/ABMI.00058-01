...
public:
    Button();
    Button(unsigned int _positionX, unsigned int _positionY, unsigned int _width, unsigned int _height, const char* _name, Window::BORDER_STYLE _borderStyle, MessageReceiver* _messageReceiver = nullptr);
    virtual ~Button();
    virtual void draw();
